...
import {
    setOrderData,
    clearpayment
} from "../../../services/checkout-payment/actions";
...
class Cart extends React.Component {
    ...
    checkPaymentRedirect = () => {
        ...
        if (params.get("preference_id")) {
            if (
                ...
                this.setState({
                    phone: this.props?.checkout_payment?.paymentOrderInfo
                        .customer_phone
                });
                this.props.createOrder(
                    this.props?.checkout_payment?.paymentOrderInfo
                );
        ...
        if (type == "ADD") {
            ...
            if (extra) {
                for (let index = 0; index < extra.length; index++) {
                    ...
                    newextra.push({
                        ...
                        calculationcount:
                            extra[index].count + extra[index].count * count
                    });
                }
            }
        } else if (type == "SUB") {
            ...
            for (let index = 0; index < extra.length; index++) {
                newextra.push({
                    ...
                    count: extra[index].count,
                    calculationcount:
                        extra[index].calculationcount - extra[index].count
                });
            }
        }
        let data = {
    ...
    renderItems = () => {
        ...
        return (
            <div className="px-15">
                <div className="border-radius-4px bg-white margin-top-15px">
    ...
    submitForm = () => {
        ...
        this.validation().then(e => {
            ...
            let data = {
                ...
                tax: Number((this.state.total * this.props.tax) / 100).toFixed(
                    2
                ),
            ...
            this.setState({
                is_completed:
                    this.props.store?.IsSMSEnabled == 1
                        ? "OTP"
                        : "WAIT_FOR_PAYMENT"
            });
            // this.setState({ is_completed: "WAIT_FOR_PAYMENT" });
            ...
            return (
                <div className="form-group">
                    ...
                    <input
                        ...
                        name="room_code"
                        placeholder={
                            translation?.enter_your_room_code ||
                            "Enter Your Code"
                        }
                    ...
                    <div className="osahan-success vh-100">
                        ...
                        <div className="p-0 bg-white text-center">
                            <h6 className="font-weight-bold text-secondary">
                                {translation?.your_order_number_is ||
                                    " Your Order No is"}
                                :
                            </h6>
                    ...
                    <div className="fixed-bottom fixed-bottom-auto red-bg p-3  text-center cart-success-footer">
                        ...
                        {this.props.is_whatsappbutton_enable == 1 ? (
                            ...
                            >
                                ...
                                <b>
                                    {translation?.send_order_whatsapp ||
                        ...
                        >
                            ...
                            <b>
                                {translation?.menu_check_orderstatus ||
                                    "Check Order Status"}{" "}
                            </b>
                        </NavLink>
                    </div>
                    ...
                    <div className="fixed-bottom-padding bg-light-v2">
                        ...
                        <div className="osahan-body">
                            ...
                            <div className="px-15">
                                    ...
                                    <div className="form-group">
                                        ...
                                        >
                                            ...
                                            1 ? null : (
                                                ...
                                                >
                                                    {translation?.cart_order_type_status_room ||
                                                        "Room"}
                                                </option>
                                            )}
                                        </select>
                                ...
                                <br />
                                <div className="">
                                    <div className="bg-white bill-details border-radius-4px mb-200">
                                        <div className="p-15">
                                            {this.InvoiceRow(
                                    ...
                                    <h6 className="m-0">
                                        ...
                                        <PriceRender
                                            ...
                                            price={
                                                ...
                                                Number(this.state.total) *
                                                    Number(this.props.tax / 100)
                                            }
                                        />
                                    </h6>
                                    <p className="m-0">
                                        {translation?.menu_confirm_order ||
                                            "Confirm your order."}
                                    </p>
                                </div>
                                <div>
...
const mapSateToProps = state => ({
    ...
    store: state.store?.payment_settings
});
