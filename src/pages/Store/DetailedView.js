                ...
                <div className="fixed-bottom-padding">
                    <div className="px-3 pb-3 descdeatils">
                        <div className="px-3 pt-3">
                            ...
                            >
                                <div>
                                    {translation?.menu_mrp || "MRP"} : &nbsp;
                                </div>
                                <div>
                                    <b className="font-weight-bold">
                                        {this.state?.product[0]?.addon_items[0]
                                            ?.categories[0]?.type == "SNG" ? (
                                            <PriceRender
                                                currency={
                                                    currency ? currency : "₹"
                                                }
                        ...
                        <div className="">
                            <div className="p-3">
                                ...
                                >
                                    {" "}
                                    {translation?.menu_product_details ||
                                        "Product Details"}
                                </p>
                                <p
                                    style={{
